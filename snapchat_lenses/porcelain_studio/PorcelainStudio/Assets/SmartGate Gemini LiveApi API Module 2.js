 ...
 * // Instead, you should modify the "SmartGate Gemini LiveApi API" script and access the functions through the imported class wrapper.
 */
...
class ApiModule extends RemoteApiService {
     ...
     */
    live_api(request) {
        return this.performApiRequest("live_api", request, [
            ["Api-Token", false],
        ]);
    }
}
