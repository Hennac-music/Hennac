 ...
 * // Instead, you should modify the "SmartGate Gemini Models API" script and access the functions through the imported class wrapper.
 */
...
class ApiModule extends RemoteApiService {
    /**
     * Performs models API call.
     *
     * @param {Object} request - The request object for the API call.
     * @param {Object} request.parameters - Parameters for the API call.
     * @param {string} request.parameters.Api-Token - Api-Token parameter value.
     * @param {string} request.parameters.model - model parameter value.
     * @param {string} request.parameters.Content-Type - Content-Type parameter value.
     * @param {string} request.parameters.type - type parameter value.
     ...
     */
    models(request) {
        return this.performApiRequest("models", request, [
            ["Api-Token", false],
            ["model", false],
            ["Content-Type", true],
            ["type", false],
