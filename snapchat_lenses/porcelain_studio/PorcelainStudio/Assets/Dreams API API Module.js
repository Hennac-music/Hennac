 ...
 * // Instead, you should modify the "Dreams API API" script and access the functions through the imported class wrapper.
 */
...
class ApiModule extends RemoteApiService {
    /**
     * Performs get_pregen_assets API call.
     *
     * @param {Object} request - The request object for the API call.
     * @param {Object} request.parameters - Parameters for the API call.
     * @param {string} request.parameters.dream_pack_id - dream_pack_id parameter value.
     * @param {string} request.parameters.profile_id - profile_id parameter value.
     ...
     * });
     */
    get_pregen_assets(request) {
        return this.performApiRequest("get_pregen_assets", request, [
            ["dream_pack_id", false],
            ["profile_id", false],
        ]);
    }
    ...
    /**
     * Performs get_lens_info API call.
     *
     * @param {Object} request - The request object for the API call.
     * @param {Object} request.parameters - Parameters for the API call.
     * @param {string} request.parameters.dream_pack_id - dream_pack_id parameter value.
     ...
     * });
     */
    get_lens_info(request) {
        return this.performApiRequest("get_lens_info", request, [
            ["dream_pack_id", false],
        ]);
    }
}
